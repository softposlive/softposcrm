 ...
 * @author softpos
 */
public class Report_hispointgu extends javax.swing.JDialog {

    /**
     * Creates new form Report_hispointgu
     */
    public Report_hispointgu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("รายงานรวมประวัติแต้ม รับเข้า/ใช้ไป ของสมาชิก");

        jPanel1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("กำหนดช่วงรหัสสมาชิก"));
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "รหัสสมาชิก", "ชื่อสมาชิก", "PStatus", "ประเภทแต้ม", "รายการ/เลขที่บิล", "วันที่", "แต้ม", "สาขา/ผู้บันทึกแต้ม", "สถานะ"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_hispointgu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Report_hispointgu dialog = new Report_hispointgu(new javax.swing.JFrame(), true);
