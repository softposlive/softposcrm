 ...
 * @author softpos
 */
public class Report_mempoint extends javax.swing.JDialog {

    /**
     * Creates new form Report_mempoint
     */
    public Report_mempoint(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("รายงานประวัติแต้มพิเศษสมาชิก");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "รหัสสมาชิก", "ชื่อสมาชิก", "ประเภทแต้มพิเศษ/โปรโมชั่น", "วันที่ได้แต้ม", "เลขที่บิล", "แต้ม", "สาขา/ผู้บันทึกแต้ม", "สถานะ"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_mempoint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Report_mempoint dialog = new Report_mempoint(new javax.swing.JFrame(), true);
